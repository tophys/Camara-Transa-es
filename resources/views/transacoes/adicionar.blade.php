...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Adicionar Transação de Crédito</div>
                <div class="card-body">
                  <form method="POST" action="{{ route('criar') }}" >
                    ...
                    <div class="form-group row">
                      <label for="valor_entrada" class="col-md-4 col-form-label text-md-right"><font color="red">* </font>Valor Entrada (R$)</label>
                      <div class="col-md-6">
                        <input id="valor_entrada" type="number" min="0" step="0.01" class="form-control currency"  class="form-control{{ $errors->has('valor_entrada') ? ' is-invalid' : '' }}" name="valor_entrada" value="0.00" required/>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col sm12 m3 right">
                        <button class="waves-effect right waves-light btn orange lighten-1">Adicionar Crédito</button>
                      </div>
                    </div>                                          
                  </form>
                </div>
